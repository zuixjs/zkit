...
zuix.controller(function (cp) {
    let menuOverlayShowing = false, menuButtonShowing = true;
    let menuButton, menuButtonClose, menuOverlay, itemsWrapper, menuItems;
    let scroller = null, currentOffset = 0;
    ...
    cp.create = function () {
        ...
        zuix.using('component', '//genielabs.github.io/zkit/lib/extensions/animate_css', function(res, ctx){
